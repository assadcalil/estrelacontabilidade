<?php
/**
 * Script de Instalação - Solução de E-mail para GED ESTRELA
 * 
 * Este script instala todos os arquivos necessários para corrigir
 * o problema de envio de e-mails no sistema GED ESTRELA.
 */
...
// Verifica o caminho do PHPMailer
$phpmailerPath = BASE_PATH . '/vendor/phpmailer/phpmailer/src/';
if (file_exists($phpmailerPath . 'PHPMailer.php')) {
    echo "✓ PHPMailer encontrado em: $phpmailerPath\n";
} else {
    echo "⚠ AVISO: PHPMailer não encontrado no caminho padrão. O script pode não funcionar corretamente.\n";
}
...
if (!file_exists($mailerDir)) {
    echo "Criando diretório: $mailerDir\n";
    mkdir($mailerDir, 0755, true);
}

if (!file_exists($testDir)) {
    echo "Criando diretório: $testDir\n";
    mkdir($testDir, 0755, true);
}

if (!file_exists($templatesDir)) {
    echo "Criando diretório: $templatesDir\n";
    mkdir($templatesDir, 0755, true);
}

// Instalar arquivos
echo "Instalando classe Mailer...\n";
file_put_contents($mailerDir . '/Mailer.php', $mailerContent);
echo "✓ Classe Mailer instalada em: " . $mailerDir . '/Mailer.php' . "\n";

echo "Instalando página de teste de e-mail...\n";
file_put_contents($testDir . '/test_email.php', $testEmailContent);
echo "✓ Página de teste instalada em: " . $testDir . '/test_email.php' . "\n";
...
if (!file_exists($constantsFile)) {
    echo "Criando arquivo de constantes...\n";
...
';
    ...
    echo "✓ Arquivo de constantes criado em: $constantsFile\n";
}

// Criar arquivo de template de e-mail de recuperação de senha
...
echo "Instalando template de e-mail de recuperação de senha...\n";
file_put_contents($templatesDir . '/password_recovery.html', $passwordRecoveryTemplate);
echo "✓ Template de recuperação de senha instalado em: " . $templatesDir . '/password_recovery.html' . "\n";
...
1. **Classe Mailer Otimizada**: `app/classes/Mailer.php`
...
2. **Página de Teste de E-mail**: `public/test/test_email.php`
...
3. **Template de E-mail**: `app/templates/emails/password_recovery.html`
...
4. **Configurações**: `app/config/constants.php`
...
1. Verifique se o arquivo `phpmailer/phpmailer` está presente na pasta `vendor`
...
echo "Criando arquivo README com instruções...\n";
file_put_contents(BASE_PATH . '/README_EMAIL_SOLUTION.md', $readmeContent);
echo "✓ Arquivo README criado em: " . BASE_PATH . '/README_EMAIL_SOLUTION.md' . "\n";

echo "\n✓ Instalação concluída com sucesso!\n";
echo "Para testar a solução de e-mail, acesse: http://seu-site.com/public/test/test_email.php\n";